...
class UserProfileFromFriendsList extends StatelessWidget {
   UserProfileFromFriendsList({Key? key,required this.index}) : super(key: key);
   int index;
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ChatCubit,ChatStates>(
        ...
        builder:(context,state){
          var userData = ChatCubit.get(context).getFriendsDataList[index];
          return Scaffold(
            appBar: AppBar(
